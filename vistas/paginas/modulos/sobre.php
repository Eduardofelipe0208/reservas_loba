...
$sobre = ControladorSobre::ctrMostrarSobre();
...
<div class="recorridoPueblo container-fluid bg-white pb-5" id="sobre">
	
	<div class="container">

		<h1 class="pt-5 text-center">Sobre nosotros</h1>	
			...
			<div class="jd-slider slidePueblo">
				...
				<div class="slide-inner">
					...
					<ul class="slide-area">
						...
						<?php foreach ($sobre as $key => $value): ?>
							...
							<div class="grid-container pt-4 pb-1 pb-lg-3 px-0 px-lg-5">
								...
								<div class="grid-item">
									...
									<img src="<?php echo $servidor.$value ["foto_peq"]; ?>"
								...
								<div class="grid-item">
									...
									<h1 class="mt-4 mb-0 my-lg-2">"<?php echo $value 
									["titulo"]; ?>"</h1>

									<p class="small p-3">"<?php echo $value 
									["descripcion"]; ?>"</p>
