...
<head>
	...
	<link rel="icon" href="img/iconobarco.jpg">
...
if(isset($_GET["pagina"])){
	...
	$rutasCategoria = ControladorCategoria::ctrMostrarCategoria();

	$validarRuta = "";

	foreach ($rutasCategoria as $key => $value) {

		if($_GET["pagina"] == $value["ruta"]){

		$validarRuta = "reservas";
	...
	=============================================*/
		...
		if($_GET["pagina"] == "reservas" || $_GET["pagina"] == "perfil" || $_GET["pagina"] == "salir" || $_GET["pagina"] == "habitaciones"){

		include "paginas/".$_GET["pagina"].".php";
		
	}else if($validarRuta != ""){

		include "paginas/embarcaciones.php";
