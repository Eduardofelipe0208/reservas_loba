...
class ModeloEmbarcaciones{
	...
	static public function mdlMostrarEmbarcaciones($tabla, $item, $valor){
	...
	static public function mdlRegistroEmbarcacion($tabla, $datos){
	...
	static public function mdlEditarEmbarcacion($tabla, $datos){
	...
	static public function mdlEliminarEmbarcacion($tabla, $id){
